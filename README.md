...
Extension of the RISC-V ISA to improve performance of NFC specific DSP algorithms | To do | WI2.5.1 | NXP, Politecnico di Torino | Design in progress | To be determined|
